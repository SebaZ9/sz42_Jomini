    ...
    public class Game
    {
        ...
        public Game()
        {
            ...
            if (Environment.OSVersion.Platform == PlatformID.Unix || Environment.OSVersion.Platform == PlatformID.MacOSX)
            {
                ...
                path = Path.Combine(dir, "ProtoMessageClient", "CSVs");
            }
            else
            {
                if (dir.Contains("bin"))
        ...
        public static ProtoMessage TravelTo(string charID, string fiefID, string[] travelInstructions, Client client)
        {
            ...
            Character charToMove = Utility_Methods.GetCharacter(charID, out errorMessage);
            if(charToMove == null) {
            ...
            charToMove.MoveTo(fiefID, out error);
            if(error != null) {
                return error;
            }
            else {
